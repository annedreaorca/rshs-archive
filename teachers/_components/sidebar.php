...
<aside id="sidebar" class="!fixed top-0 left-0 h-screen w-68 !bg-white shadow-lg transform -translate-x-full transition-transform duration-300 lg:translate-x-0 lg:relative p-6 !z-[99999]">
    ...
    <nav class="mt-5 space-y-2">
        ...
        <a href="/rshs-archive/teachers/users" class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-gray-200 rounded-lg sidebar-link-item <?= setActiveClass('users.php') ?>">
        ...
        <a href="/rshs-archive/logout" class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-gray-200 rounded-lg sidebar-link-item <?= setActiveClass('logout.php') ?>">
